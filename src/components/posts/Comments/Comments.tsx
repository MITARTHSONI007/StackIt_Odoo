...
const Comments: React.FC<CommentsProps> = ({
  ...
  const onCreateComments = async (title: string, description: string, tags: string) => {
    try {
      ...
      const newComment: Comment = {
        ...
        text: CryptoJS.AES.encrypt(JSON.stringify(description), process.env.NEXT_PUBLIC_CRYPTO_SECRET_PASS as string).toString(),
        title: CryptoJS.AES.encrypt(JSON.stringify(title), process.env.NEXT_PUBLIC_CRYPTO_SECRET_PASS as string).toString(),
        tags: CryptoJS.AES.encrypt(JSON.stringify(tags), process.env.NEXT_PUBLIC_CRYPTO_SECRET_PASS as string).toString(),
