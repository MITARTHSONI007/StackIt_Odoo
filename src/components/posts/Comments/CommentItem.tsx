...
const CommentItem: React.FC<CommentItemProps> = ({
  ...
  useEffect(() => {
    const arr = [comment.text, comment.creatorDisplayText, comment.postTitle];
    const arrName = ["text", "creatorDisplayText", "postTitle"];
  ...
  return (
    <Flex>
      ...
      <Stack spacing={1}>
        ...
        {decryptedData.postTitle && (
          <Text fontWeight="bold" fontSize="11pt" mb={1}>{decryptedData.postTitle}</Text>
        )}
